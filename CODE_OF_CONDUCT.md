...
reported to the maintainers at **security@rileybetts.ai** (subject prefix
`[CONDUCT] lean-grpc`). All complaints will be reviewed and investigated promptly
and fairly.
...
2. **Warning** — A warning with consequences for continued behaviour, which may
   include a temporary interaction ban.
