...
class HookServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.SetReturnStatus = channel.unary_unary(
                ...
                request_serializer=messages__pb2.SetReturnStatusRequest.SerializeToString,
                response_deserializer=empty__pb2.Empty.FromString,
                _registered_method=True)
...
def add_HookServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SetReturnStatus': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=messages__pb2.SetReturnStatusRequest.FromString,
                    response_serializer=empty__pb2.Empty.SerializeToString,
            ),
...
class HookService:
    ...
    def SetReturnStatus(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/grpc.testing.HookService/SetReturnStatus',
            messages__pb2.SetReturnStatusRequest.SerializeToString,
            empty__pb2.Empty.FromString,
            options,
            channel_credentials,
            insecure,
...
class XdsUpdateHealthServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.SendHookRequest = channel.unary_unary(
                ...
                request_serializer=messages__pb2.HookRequest.SerializeToString,
                response_deserializer=messages__pb2.HookResponse.FromString,
                _registered_method=True)
...
def add_XdsUpdateHealthServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            ...
            'SendHookRequest': grpc.unary_unary_rpc_method_handler(
                    ...
                    request_deserializer=messages__pb2.HookRequest.FromString,
                    response_serializer=messages__pb2.HookResponse.SerializeToString,
            ),
    }
    generic_handler = grpc.method_handlers_generic_handler(
...
class XdsUpdateHealthService:
    ...
    def SendHookRequest(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/grpc.testing.XdsUpdateHealthService/SendHookRequest',
            messages__pb2.HookRequest.SerializeToString,
            messages__pb2.HookResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
